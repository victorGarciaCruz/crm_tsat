...
class ModeloFacturasCliente{
    ...
    public function registrosAdminTablaClassBuscar($filas,$orden,$filaspagina,$tipoOrden,$cond){
        ...
        $this->db->query("SELECT fac.id as 'Nº', fac.numero as 'Numero factura', fac.cliente,  
    ...
    {     
        $this->db->query("INSERT INTO facturasclientes (numero,numerointerno,idcliente,cliente,fecha,vencimiento,observaciones,estado,idcuentabancaria,idformacobro,diascobro) VALUES (:numero,:numerointerno,:idcliente,:cliente,:fecha,:vencimiento,:observaciones,:estado,:idcuentabancaria,:idformacobro,:diascobro)");      
    ...
    public function verificarSiExistenFacturasPosteriores($idFactura, $anioFactura, $numerointerno)
    {
