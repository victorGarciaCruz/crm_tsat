...
class Tecnicos extends Controlador {
    ...
    public function crearTablaTecnicos()
    {
        ...
        if ($buscar != "") {               
            ...
            $tecnicos = $this->ModelTecnicos->obtenerTecnicosTablaClassBuscar($filas,$orden,$filaspagina,$tipoOrden,$cond);

        }else{
            
            $tecnicos = $this->ModelTecnicos->obtenerTecnicosTablaClass($filas,$orden,$tipoOrden,$filaspagina);
        }        
