...
class FormasDePago extends Controlador {
    ...
    private function mapearCampoOrdenFormaDePago($campoVisible) {
        $mapa = [
            'Nº'             => 'id',
    ...
    private function construirClausulaOrderByFormasDePago($ordenMultipleJson, $ordenSimple, $tipoSimple) {
        ...
        if (!empty($ordenMultipleJson)) {
            ...
            if (is_array($ordenes) && count($ordenes) > 0) {
                ...
                foreach ($ordenes as $item) {
                    ...
                    $campoSQL = $this->mapearCampoOrdenFormaDePago($campoVisible);
    ...
    public function crearTablaFormasDePago()
    {
        ...
        if (!empty($ordenMultiple)) {
            ...
            $clausulaOrder = $this->construirClausulaOrderByFormasDePago($ordenMultiple, $ordenSimple, $tipoSimple);
        ...
        $datosRetorno = $this->ModelFormasDePago->obtenerFormasDePagoTablaClassBuscar($filas,$ordenFinal,$filaspagina,$tipoFinal,$cond);
